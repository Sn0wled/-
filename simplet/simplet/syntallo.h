...
// syntallo.h
// синтаксическая таблица LL с операционными символами
...
sttype RULE[27][ST_MAX_RULE_LEN] = {
    ...
    /* 7 SYM_A  */{ TOK_ELSE, TOK_LF, OUT_PUSH, OUT_BR, OUT_SWAP, OUT_DEFL, SYM_M, OUT_POPL, OUT_DEFL, TOK_END, TOK_IF, TOK_LF, TOK_EOT },
    ...
    /*11 SYM_R_ */{ TOK_EQ, SYM_R, OUT_EQ, SYM_R_, TOK_EOT },
    /*12 SYM_R_ */{ TOK_NE, SYM_R, OUT_NE, SYM_R_, TOK_EOT },
    /*13 SYM_R_ */{ TOK_LT, SYM_R, OUT_LT, SYM_R_, TOK_EOT },
    /*14 SYM_R_ */{ TOK_GT, SYM_R, OUT_GT, SYM_R_, TOK_EOT },
    /*15 SYM_R_ */{ TOK_EOT },
    /*16 SYM_R  */{ SYM_T, SYM_T_, TOK_EOT },
    /*17 SYM_T_ */{ TOK_ADD, SYM_T, OUT_ADD, SYM_T_, TOK_EOT },
    /*18 SYM_T_ */{ TOK_SUB, SYM_T, OUT_SUB, SYM_T_, TOK_EOT },
    /*19 SYM_T_ */{ TOK_EOT },
    /*20 SYM_T  */{ SYM_P, SYM_P_, TOK_EOT },
    /*21 SYM_P_ */{ TOK_MUL, SYM_P, OUT_MUL, SYM_P_, TOK_EOT },
    /*22 SYM_P_ */{ TOK_DIV, SYM_P, OUT_DIV, SYM_P_, TOK_EOT },
    /*23 SYM_P_ */{ TOK_EOT },
